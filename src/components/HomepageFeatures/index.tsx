...
const FeatureList: FeatureItem[] = [
  {
    ...
    image: require('@site/static/img/roadmap-session-1.webp'),
    description: (
      <>
  ...
  },
  {
    ...
    image: require('@site/static/img/roadmap-session-2.webp'),
    description: (
      <>
  ...
  },
  {
    ...
    image: require('@site/static/img/roadmap-session-3.webp'),
    description: (
      <>
